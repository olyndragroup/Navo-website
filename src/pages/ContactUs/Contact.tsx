...
const Contact: React.FC = () => {
  ...
  const phonePlaceholder = country === "us" ? "(555) 000-0000" : "7012345678";
  ...
  return (
    <section className="bg-[#F5F7FA] py-16 lg:py-24" id="contact-us">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="mb-8">
          <h2 className="text-sm font-semibold tracking-wide text-[#3F51B5] mb-3 text-left">
            Contact us
          </h2>
          <h1 className="text-3xl sm:text-4xl font-semibold text-[#2E2E2E] mb-4 text-left">
            Get in touch
          </h1>
