...
function Body() {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white text-[#667085]">
      {/* Introduction section */}
      <section className="mb-10">
        <p className="mb-4">
          Mi tincidunt elit, id quisque ligula ac diam, amet. Vet etiam
      ...
      <section className="mb-10">
        ...
        <p className="mb-4">
          ...
          odio nisi vitae. In aliquet pellentesque aenean hac vestibulum turpis
      ...
      <section className="mb-10">
        ...
        <p>
          ...
          aliquam ullamcorper porttitor. Pulvinar ullamcorper sit dictumat ut
      ...
      <section className="mb-10">
        ...
        <p className="mb-6">
          Sagitits et eu at elementum, quis in. Proin praesent volutpat egestas
          ...
          ultrices at diam qui eget fringilla tincidunt. Arcu sit dignissim
        ...
        <ol className="list-decimal pl-6 space-y-3">
          <li className="pl-2">
            ...
            <span className="underline">gravida morbi</span>.
          </li>

          <li className="pl-2">
            Eu turpis <span className="underline">posuere semper feugiat</span>{" "}
            volutpat elit, ultrices suspendisse. Auctor vel in vitae placerat.
          </li>
          <li className="pl-2">
            Suspendisse maecenas ac
            <span className="underline"> donec scelerisque</span>{" "}
